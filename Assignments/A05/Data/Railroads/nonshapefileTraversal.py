...
EDGES = ("Railroads.geojson/EDGE.shp")
VERTS = ("Railroads.geojson/VERTS.shp")
...
def geoToShape(file = RRBENDELLjson):
    ...
    args = ['ogr2ogr', '-f', 'ESRI Shapefile', EDGES, RRBENDELLjson]
...
#     print("In TRAVERSE")
#     with arcpy.da.UpdateCursor(VERTS,"test") as cursor:
#         for row in cursor:
#            print (row)
#     print (" ")
